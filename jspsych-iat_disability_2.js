...
var instructions_block1 = {
  ...
  "<strong>悪い</strong><br>" + "　　　<br>" + "<strong>障害者</strong></div>" +
...
var instructions_block2 = {
  ...
  stimulus: 
  "<div style='position: absolute; top: 18%; left: 20%'>Eキーを押す:<br> " +
  "<strong>良い</strong><br>" + "　　　<br>" + "<strong>障害者</strong></div>" +
  "<div style='position: absolute; top: 18%; right: 20%'>Iキーを押す:<br>" +
  ...
  timeline: [
    {
      ...
      response_ends_trial: true,
      data: { iat_type: '不一致練習_disability' }
    }
  ],
  timeline_variables: [
      {type: 'iat-html', stimulus: "好感の持てる", stim_key_association: "left"},
  ...
  timeline: [
    {
      ...
      right_category_label: ['悪い', '　　　'],
      response_ends_trial: true,
      data: { iat_type: '不一致本番_disability' }
    }
  ],
  timeline_variables: [
      {type: 'iat-html', stimulus: "好感の持てる", stim_key_association: "left"},
